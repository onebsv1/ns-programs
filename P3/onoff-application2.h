...
#ifndef ONOFF_APPLICATION2_H
#define ONOFF_APPLICATION2_H
 ...
 * \defgroup onoff OnOffApplication2
 *
...
*/
class OnOffApplication2 : public Application 
{
public:
  /**
